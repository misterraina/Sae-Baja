      ...
      <div className="w-[50%] pl-8 flex flex-col justify-between">
        <div
          className={`border-l-4 ${
            activeSection === "Lottery"
              ? "border-black dark:border-dark-200"
              : "border-0 border-white dark:border-dark-600"
          }`}
        >
          <div
          ...
          >
            <h1 className="text-3xl font-semibold dark:text-dark-200">
              Vehicle Specs
            </h1>
        ...
        >
          ...
          >
            ...
            <p className="dark:text-dark-200">
              Follow our progress as we build and test our electric vehicle for
              the competition.
            </p>
          </div>
        </div>
