...
export default function Navbar() {
  return (
    <div className="flex justify-between items-center w-full px-10 py-4 top-0 left-0 z-50 fixed bg-white">
    ...
    {["home", "specs", "team", "contact"].map((item) => (
      <li key={item} className="relative cursor-pointer font-semibold text-lg group">
        <span className="bg-gradient-to-r from-orange-700 to-orange-700 bg-[length:0%_100%] bg-left-bottom bg-no-repeat transition-all duration-500 group-hover:bg-[length:100%_100%] text-gray-800 group-hover:text-transparent bg-clip-text">
          #{item}
        </span>
      </li>
    ))}
